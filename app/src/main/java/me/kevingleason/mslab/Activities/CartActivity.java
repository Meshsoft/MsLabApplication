...
public class CartActivity extends AppCompatActivity {
   ...
   //end of the other View
    ...
    public void RemoveSelectedItems(View view){ //this is for to Remove Selected
        ...
        if(selectedProducts_list.size()>0){ //this is for the selected List size
              ...
              try{
                  ...
                  if(isOnline()){ //this is for the that we online
                      ...
                      builder.setMessage("Dear user You are in Offline Mode would you like to save order to Process When Device comes online Mode");
    ...
    public void SendOrder(final JSONArray jsonArray){ //this is for to put
        ...
        try{//this is for the online order
            ...
            alertDialog.setMessage("Are you sure to process the  selected items that are in length as "+jsonArray.length());
